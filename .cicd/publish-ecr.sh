...
SRC_IMAGE="$HARBOR_REGISTRY/$HARBOR_PROJECT/$HARBOR_REPOSITORY:$APP_PROFILE-$APP_VERSION"

DST_REGISTRY='public.ecr.aws'
DST_REPOSITORY="$APP_NAME/$APP_COMPONENT"
DST_IMAGE="$DST_REGISTRY/$NAMESPACE/$DST_REPOSITORY:$APP_PROFILE-$APP_VERSION"
